...
Public Class SQLDataAccess
    ...
    ''' </returns>
    Public Function OpenData(ByVal sCnn As String, ByVal sCommand As String, ByRef Connection As SqlConnection, ByRef command As SqlCommand) As Boolean

        Dim Retorno As Boolean

        Retorno = True
        Connection = New SqlConnection(sCnn)
        command = New SqlCommand(sCommand, Connection)
    ...
    ''' </returns>
    Public Function CloseConn(ByRef Connection As SqlConnection) As Boolean
    ...
    ''' </returns>
    Public Function GetDataDb_Reader(ByVal sCnn As String, ByVal sCommand As String, Optional ByVal nCarga As wsCargaTipo = wsCargaTipo.wsNormal) As SqlDataReader
    ...
    Public Function GetDataDb(sCnn As String, cConn As String, Optional ByVal nCarga As wsCargaTipo = wsCargaTipo.wsNormal) As DataSet
        ...
        da = New SqlDataAdapter(cConn, Connection)
